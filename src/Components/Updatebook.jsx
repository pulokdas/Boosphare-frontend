        ...
        <div className="md:w-8/12 p-10 bg-gray-700 bg-opacity-50 border-t-4 border-[#E6E6E6] rounded-md shadow-md border-top ">
          ...
          <form onSubmit={handleAddbook} className="space-y-3">
            ...
            <div className='pt-5'>
              ...
              <input type="submit" className='btn btn-outline  rounded bg-gray-300   text-gray-700  border-gray-700 w-full  hover:bg-gray-700 hover:text-gray-100 uppercase' value="Update Book" />
            </div>
