  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <div class="relative flex flex-col rounded-xl bg-transparent bg-clip-border  text-center  shadow-none">
        <h4 class="text-gray-700 block font-sans text-2xl font-semibold leading-snug tracking-normal  antialiased">
          Sign Up
        </h4>
        ...
        <form onSubmit={handleSubmit} class="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
          ...
          <div class="inline-flex items-center">
            ...
            >
              <input
                type="checkbox"
                class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-pink-500 checked:bg-gray-700 checked:before:bg-gray-700 hover:before:opacity-10"
                id="checkbox"
              />
            ...
            >
              <p class="flex items-center font-sans text-sm font-normal leading-normal text-gray-400 antialiased">
                I agree the
                <a
                  class="font-medium transition-colors hover:text-gray-700"
                  href="#"
                >
          ...
          <button
            class="btn  w-full  rounded bg-gray-700   text-gray-100  border-gray-700   hover:bg-gray-100 hover:text-gray-700"
            type="submit"
            data-ripple-light="true"
          >
            Register
          </button>
          <button onClick={handleGoogleSignIn} className="btn btn-outline w-full rounded bg-gray-300   text-gray-700  border-gray-700   hover:bg-gray-700 hover:text-gray-100">
           <FaGoogle/>
           SignIn With Google
          </button>
